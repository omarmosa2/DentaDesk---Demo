...
export default function ReportsPasswordSettings() {
  ...
  const handleDisablePassword = async () => {
    if (!confirm('هل أنت متأكد من حذف كلمة المرور؟ سيتم السماح بالوصول المباشر لقسم التقارير.')) {
      return
    }
    ...
    try {
      ...
      toast({
        ...
        description: 'يمكنك الآن الوصول لقسم التقارير مباشرة بدون كلمة مرور',
        variant: 'default',
      })
    } catch (error) {
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-right">
                    {hasExistingPassword
                      ? 'تغيير كلمة مرور قسم التقارير'
                      : 'إعداد كلمة مرور لحماية قسم التقارير'
                    }
                  </CardDescription>
                </div>
              </div>
