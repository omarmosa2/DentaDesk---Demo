...
interface ReportsPasswordModalProps {
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
...
export default function ReportsPasswordModal({
  isOpen,
  onClose,
  onSuccess,
  onForgotPassword
}: ReportsPasswordModalProps) {
    ...
    try {
      ...
      if (isValid) {
        toast({
          ...
          description: 'مرحباً بك في قسم التقارير',
          variant: 'default',
        })
        onSuccess()
        onClose()
          ...
          {isLocked && (
            <Alert variant="destructive">
              ...
              <AlertDescription className="text-right">
                تم قفل النظام لمدة {remainingTime} ثانية بسبب تجاوز عدد المحاولات المسموحة
              </AlertDescription>
            </Alert>
          )}
